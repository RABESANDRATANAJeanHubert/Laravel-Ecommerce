<div>
    <div class="container" style="padding: 30 px  0;">
             ...
             <div class="panel-body">
                 <form class="form-horizontal" wire:submit.prevent="UpdateHomeSlide">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="file"  class="input-file" wire:model="nimage">
                            @if ($image)
                                <img src="{{$image->temporaryUrl()}}" width="120">
                                @else
                                <img src="{{asset('assets/images/slides')}}/{{$image}}">
                            @endif
                        </div>
                    </div>
                    <div class="form-group">
