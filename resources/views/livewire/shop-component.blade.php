                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    ...
                                    <div class="productinfo text-center">
                                        <img src="{{ asset('assets/images/products')}}/{{$products->image}} " alt="{{$products->image}}" />
                                    ...
                                    <div class="product-overlay">
                                        <div class="overlay-content">
                                            <a href="#" class="btn btn-default add-to-cart" wire:click.prevent="store({{$products->id}},'{{$products->name}}',{{$products->regular_price}})"><i class="fa fa-shopping-cart" ></i>Add to cart</a>
                                        </div>
                                    </div>
                                    <div class="choose">
                                        <ul class="nav nav-pills nav-justified">
                                            <li><a href=""><i class="fa fa-plus-square"></i>Add to wishlist</a></li>
                                            {{-- <a href="{{route('product.detail',['slug'=>$products->slug])}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Detail</a> --}}
                                            <a href="{{route('product.detail',['slug'=>$products->slug])}}" title="{{$products->name}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Detail</a>
                                            {{-- <li><a href="" wire:click.prevent="store({{$products->id}},{{$products->name}},{{$products->regular_price}})"><i class="fa fa-plus-square" ></i>Add to compare</a></li> --}}
                                        </ul>
                                    </div>
                                    @endforeach
                                </div>
