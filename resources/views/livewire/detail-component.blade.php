                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    {{-- <a data-toggle="collapse" data-parent="#accordian" href="" wire:click.prevent="store({{$products->id}},{{$products->name}},{{$products->regular_price}})"> --}}
                ...
                <div class="brands_products"><!--brands_products-->
                    ...
                    <div class="price-range"><!--price-range-->
                        ...
                        <div class="well">
                             ...
                             {{-- <b>$ 0</b> <b class="pull-right">{{$produt->stock_status}}</b> --}}
                        </div>
                    </div><!--/price-range-->
                ...
                <div class="product-details"><!--product-details-->
                    ...
                    <div class="col-sm-7">
                        <div class="product-information"><!--/product-information-->
                            <img src="{{$product->image}}" class="newarrival" alt="" />
                            {{-- <h2><b>Nom:<b>{{$product->name}}</h2> --}}
                            <p><b>Prix:<b>{{$product->regular_price}}</p>
                            ...
                            <p><b>availability:</b> {{$product->stock_status}}</p>
                            <p><b>description:</b>{{$product->description}}</p>

                            <p><b>Brand:</b> E-SHOPPER</p>
                            <a href="" wire:click.prevent = "store({{$product->id}},'{{$product->name}}',{{$product->regular_price}})" ><img src="{{ asset('assets/images/product-details/share.png')}}" class="share img-responsive"  alt="" /></a>
